...
namespace BasicTestApp
{
    internal class WebAssemblyConsoleLogger<T> : ILogger<T>, ILogger
    {
        ...
        public WebAssemblyConsoleLogger(IJSRuntime jsRuntime)
            : this(string.Empty, jsRuntime) // Cast for DI
        {
        }

        public WebAssemblyConsoleLogger(string name, IJSRuntime jsRuntime)
        {
                ...
                try
                {
                    ...
                    switch (logLevel)
                    {
                        ...
                        case LogLevel.Critical:
                            _jsRuntime.InvokeVoidAsync("console.error", $"Blazor._internal.dotNetCriticalError: {formattedMessage}");
                            break;
